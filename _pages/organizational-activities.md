...
### [New horizons in the well-posedness of stochastic differential equations]([https://example.com/workshop-page](https://www.lorentzcenter.nl/new-horizons-in-well-posedness-of-stochastic-differential-equations.html))
...
#[Click here to download the poster (PDF)]({{ "/files/my-workshop-poster.pdf" | relative_url }})

![Workshop poster]({{ "/images/poster.png" | relative_url }})
